...
<html lang="en">
    <head>
        ...
        <title>Hotels Booking-Login</title>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="login" method="POST">
                                ...
                                <div class="g-recaptcha" data-sitekey="6Lf3RtwZAAAAAPnrg8r9zsdYYDd5TgaDd4K1wh9x"></div>
                                <div class="form-group">
                                    <input type="submit" value="Login" class="btn btn-dark">
                                    <a href="recover.jsp">I forgot my password.</a>
                                </div>
                            </form>
                        </div>
                        <div class="card-footer">
                            <div class="d-flex justify-content-center links">
                                <a class="btn btn-dark" href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=http://localhost:8080/J3.L.P0012.-The-Hotel/loginGoogle&response_type=code
                                   &client_id=486130408267-0rvsqmf504fvn7db9frmhmgjs83n7ftn.apps.googleusercontent.com&approval_prompt=force">Login With Google</a>
